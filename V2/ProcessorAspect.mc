...
char * PSW_BITS_names [10]={"POWEROFF_BIT","UNUSED","UNUSED",
"UNUSED","UNUSED","UNUSED","UNUSED","EXECUTION_MODE_BIT","UNUSED","UNUSED"};
...
void Processor_FetchInstruction() {
    ...
    if (MMU_readMemory()==1) {
      ...
      ComputerSystem_DebugMessage('h',"csdsds",registerIR_CPU.operationCode," ",registerIR_CPU.operand1," ",registerIR_CPU.operand2, " ");
    }
    else
