...
typedef struct {int busy; int initialPhysicalAddress; int processSize; int state; int priority; int queueID; int copyOfPCRegister; int copyOfAccumulator; int whenToWakeUp; 
}PCB; 
...
void Processor_ShowTime(char section); 
#line 32 "Processor.c"
char *PSW_BITS_names[10] = {"POWEROFF_BIT","UNUSED","UNUSED","UNUSED","UNUSED","UNUSED","UNUSED","EXECUTION_MODE_BIT","UNUSED","UNUSED"}; 
#line 35 "Processor.c"
int registerPC_CPU; 
#line 36 "Processor.c"
...
#line 82 "Processor.c"
ComputerSystem_DebugMessage('h', "csdsds", registerIR_CPU.operationCode, " ", registerIR_CPU.operand1, " ", registerIR_CPU.operand2, " "); } }else{
...
ComputerSystem_DebugMessage('h', "sRdsRdsds", "(PC: ", registerPC_CPU, ", Accumulator: ", registerAccumulator_CPU, ", PSW: ", registerPSW_CPU, ")\n"); 
...
static inline void  operatingSystemRoutine__ProcessorAspect__0 (void (* __utac__fp__para) () )  ; 

#line 202 "Processor.c"
void Processor_ManageInterrupts()  
# 995 "ProcessorAspect.c"
{
...
#line 206 "Processor.c"
void (*operatingSystemRoutine)(void );
...
operatingSystemRoutine = interruptVectorTable[i]; 
#line 223 "Processor.c"
((operatingSystemRoutine__ProcessorAspect__0))( operatingSystemRoutine    ); } }} 
# 1029 "ProcessorAspect.c"

}

# 1033 "ProcessorAspect.c"
...
{
    void OperatingSystem_HandleException (void   ) ;  
if( (__utac__fp__para==OperatingSystem_HandleException  ) ) { 
...
{
    void OperatingSystem_HandleSystemCall (void   ) ;  
if( (__utac__fp__para==OperatingSystem_HandleSystemCall  ) ) { 
...
{
    void OperatingSystem_HandleClockInterrupt (void   ) ;  
if( (__utac__fp__para==OperatingSystem_HandleClockInterrupt  ) ) { 
...
ComputerSystem_DebugMessage('h', "sRss", (nbit != POWEROFF_BIT?"Activating PSW bit: ":" Activating PSW bit: "), PSW_BITS_names[nbit], (nbit != POWEROFF_BIT?"\n":" ")); 
...
ComputerSystem_DebugMessage('h', "sRss", "Deactivating PSW bit: ", PSW_BITS_names[nbit], "\n"); 
